...
export type Props = Record<string, any> & { children?: Child[]; key?: string | number };
export type Component<P = any> = (props: P) => VNode | PrimitiveChild;
export type VNode = { type: string | Component | symbol; props: Props };
...
export type EffectRecord = { deps?: any[]; cleanup?: (() => void) | undefined; effect?: (() => void | (() => void)) | undefined };
